  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/10 to-primary/5 p-4 relative overflow-hidden animate-fade-in">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Login Card */}
        <div className="bg-background/50 backdrop-blur-xl rounded-2xl border border-border/30 p-6 shadow-2xl opacity-0 animate-[fade-in_0.5s_ease-out_0.4s_forwards]">
          <p className="text-sm text-muted-foreground text-center mb-5">Sign in to continue</p>
          
          <div className="space-y-3">
            <Button 
              variant="outline" 
              className="w-full h-12 gap-3 bg-background/60 backdrop-blur-md border-border/50 hover:bg-background/80 hover:border-primary/50 hover:shadow-lg transition-all duration-300 group rounded-xl hover:scale-[1.02]"
