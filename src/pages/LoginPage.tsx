    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/10 to-primary/5 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-6">
          <div className="relative inline-block">
            ...
            <img 
              src={paletteLogo} 
              alt="Palette" 
              className="w-24 h-24 rounded-full mx-auto shadow-2xl object-cover ring-4 ring-background/80 relative z-10"
            />
        ...
        <div className="space-y-3 px-2">
          <Button 
            variant="outline" 
            className="w-full h-12 gap-3 bg-background/60 backdrop-blur-sm border-primary/20 hover:bg-background/80 hover:border-primary/40 transition-all duration-300 group shadow-lg"
